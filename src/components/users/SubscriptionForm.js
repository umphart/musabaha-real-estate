    ...
    try {
      ...
      if (data.success) {
        ...
        if (data.data.length > 0) {
          ...
          const fullUrl = `https://musabaha-homes-ltd.com.ng${data.data[0].file_url}`;
...
const fetchPlots = async () => {
  ...
  const handleLayoutSelect = (layout) => {
    ...
    const fullUrl = `https://musabaha-homes-ltd.com.ng${layout.file_url}`;
  ...
  const handleDownloadLayout = async (layout) => {
    try {
      ...
      const response = await fetch(`https://musabaha-homes-ltd.com.ng/api/layout-plan/download/${layout.id}`, {
        method: 'GET',
        headers: token ? { 
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await fetch("https://musabaha-homes-ltd.com.ng/api/subscriptions", {
      method: "POST",
            ...
            <div className="selected-layout">
              ...
              <div className="layout-actions">
                <button 
                  ...
                  onClick={() => handleViewPdf(`https://musabaha-homes-ltd.com.ng${selectedLayout.file_url}`)}
                >
                  ...
                  <div key={layout.id} className="layout-card">
                    ...
                    <div className="layout-actions">
                      ...
                      <button 
                        type="button" 
                        className="btn-view-layout"
                        onClick={() => handleViewPdf(`https://musabaha-homes-ltd.com.ng${layout.file_url}`)} 
                      >
                        <FiEye className="icon" /> View
                      </button>
                      <button 
