...
const AdminPlots = () => {
  ...
  const fetchPlots = () => {
    fetch("https://musabaha-homes-ltd.com.ng/api/plots")
      .then(res => res.json())
      .then(data => {
  ...
  const fetchLayoutPlan = async () => {
    try {
      const res = await fetch("https://musabaha-homes-ltd.com.ng/api/layout-plan");
  ...
  const fetchAllLayoutPlans = async () => {
    try {
      const res = await fetch("https://musabaha-homes-ltd.com.ng/api/layout-pla12345679ll");
      const data = await res.json();
      if (data.success) {
  ...
  const handleCreatePlot = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://musabaha-homes-ltd.com.ng/api/plots", {
        method: "POST",
  ...
  const handleDownloadLayout = async (layoutId = null) => {
    ...
    try {
      const response = await fetch(`https://musabaha-homes-ltd.com.ng/api/layout-plan/download/${layoutToDownload.id}`);
      if (response.ok) {
  ...
  const handleDeleteLayout = async (layoutId) => {
    ...
    if (result.isConfirmed) {
      try {
        const res = await fetch(`https://musabaha-homes-ltd.com.ng/api/layout-plan/${layoutId}`, {
          method: 'DELETE'
        });
        const data = await res.json();
        ...
        <div className="layout-plan-section">
          <div className="layout-plan-card">
            ...
            <div className="layout-plan-actions">
              ...
              <a 
                href={`https://musabaha-homes-ltd.com.ng${layoutPlan.file_url}`} 
                target="_blank" 
                ...
                {allLayoutPlans.map(layout => (
                  <div key={layout.id} className="layout-card">
                    ...
                    <div className="layout-actions">
                      ...
                      <a 
                        href={`https://musabaha-homes-ltd.com.ng${layout.file_url}`} 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="icon-btn info"
                        data-tooltip="View"
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={async (e) => {
                e.preventDefault();
                try {
                  const res = await fetch(`https://musabaha-homes-ltd.com.ng/api/plots/${editPlot.id}`, {
                    method: 'PUT',
                    headers: { "Content-Type": "application/json" },
