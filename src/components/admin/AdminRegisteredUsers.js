                ...
                <ul style={docListStyles}>
                  {selectedUser.passport_photo && (
                    <li style={docListItemStyles}>
                      ...
                      <a
                        href={`https://musabaha-homes-ltd.com.ng/uploads/${selectedUser.passport_photo}`}
                        target="_blank"
                  ...
                  {selectedUser.identification_file && (
                    <li style={docListItemStyles}>
                      ...
                      <a
                        href={`https://musabaha-homes-ltd.com.ng/uploads/${selectedUser.identification_file}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={docLinkStyles}
                      >
                  ...
                  {selectedUser.utility_bill_file && (
                    <li style={docListItemStyles}>
                      ...
                      <a
                        href={`https://musabaha-homes-ltd.com.ng/uploads/${selectedUser.utility_bill_file}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={docLinkStyles}
                      >
                  ...
                  {selectedUser.signature_file && (
                    <li style={docListItemStyles}>
                      ...
                      <a
                        href={`https://musabaha-homes-ltd.com.ng/uploads/${selectedUser.signature_file}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={docLinkStyles}
                      >
