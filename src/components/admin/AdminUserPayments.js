...
const AdminUserPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      const response = await fetch("https://https://musabaha-homes.onrender.com/api/user-payments");
  ...
  const handlePaymentAction = async (paymentId, action) => {
    try {
      ...
      const response = await fetch(
        `https://https://musabaha-homes.onrender.com/api/user-payments/${paymentId}/status`,
        {
          method: "PATCH",
              ...
              {payments.map((p) => (
                <tr key={p.id}>
                  ...
                  <td>
                    {p.receipt_file ? (
                      <a
                        href={`https://https://musabaha-homes.onrender.com/uploads/receipts/${p.receipt_file}`}
                        target="_blank"
